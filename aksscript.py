...
# create kubernetes service/cluster in azure        
    # create rg-> 
        # az group create --name myAKSResourceGroup --location eastus
    # create acr -> 
        # az acr create --resource-group myAKSResourceGroup --name pykub --sku Basic
    # login to acr -> 
        # az acr login --name pykub
    # retag local image for azure -> 
        # docker tag <localcontainer:image> <containername.azurecr.io>/obiwankubernetes/pyazure
    # create aks cluster -> 
    ...
    # get public facing url to test deployment and see app -> 
